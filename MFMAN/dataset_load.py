...
def my_baseline_dataset(FLAG):
    ...
    train_dataset = my_dataset(class_name = classname,data_dir=train_path,is_train=True,transform=train_transform,saliency_map_add=saliency_map_add,saliency_map_cat=saliency_map_cat)
    #print(train_dataset[1])
    test_dataset = my_dataset(class_name = classname,data_dir=train_path,is_train=False,transform=test_transform,saliency_map_add=saliency_map_add,saliency_map_cat=saliency_map_cat)
...
def my_cross_dataset(FLAG):
    ...
    #ource_test_dataset = my_dataset(class_name = classname,data_dir=source_train_path,is_train=False,transform=train_transform)
